...
export interface MainWindow extends Electron.BrowserWindow {
    forceClose: boolean
}
...
export function createWindow(name : string, options : WindowsState) :MainWindow{
    ...
    win = <MainWindow> new BrowserWindow(Object.assign({}, options, state));
